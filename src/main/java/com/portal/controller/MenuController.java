...
public class MenuController extends BaseController {
	...
	public ResponseEntity<List<MenuModel>> search(@Valid @RequestBody MenuModel model) throws AppException, BusException {
	...
	public ResponseEntity<MenuModel> save(@Valid @RequestBody MenuModel model, BindingResult result) throws AppException, BusException {
